...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: isLoggedIn ? MyHomePage(isAdmin: isAdmin, title: 'MTL') : LoginScreen(),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    // Tab skaits tiek mainīts atkarībā no admin statusa
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: DefaultTabController(
        length: widget.isAdmin ? 3 : 2, // Mainām tab skaitu atkarībā no admin statusa
        child: Column(
          children: [
            TabBar(
              ...
              tabs: [
                ...
                if (widget.isAdmin) const Tab(text: 'Lietotāji'), // Rādām šo tab tikai admin
              ],
            ),
            Expanded(
              child: TabBarView(
                ...
                children: [
                  Taken(),
                  Reservation(),
                  if (widget.isAdmin) Users(), // Parādām "Users" tikai admin
                ],
              ),
            ),
          ],
